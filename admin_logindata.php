    ...
    <script>
        $(document).ready(function(){
            $(".dashboard-link").click(function(e){
                ...
                $("#right_sidebar").load(page); // Load content into right_sidebar
            });
        });
    </script>
</head>
    ...
    <div class="row">
        <div class="col-md-2" id="left_side">
            <table class="table dashboard-table">
                <tr>
                    <td><a href="admin_dashboard.php" class="dashboard-link">Dashboard</a></td>
                </tr>
                <tr>
                    <td><a href="create_task.php" class="dashboard-link">Create Task</a></td>
                </tr>
                <tr>
                    <td><a href="manage_task.php" class="dashboard-link">Manage Task</a></td>
                </tr>
                <tr>
                    <td><a href="leave-application.php" class="dashboard-link">Leave Application</a></td>
                </tr>
                <tr>
                    <td><a href="login.php" class="dashboard-link">Logout</a></td>
                </tr>
            </table>
        </div>
